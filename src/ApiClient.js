...
class ApiClient {
    constructor() {
         ...
         * @type {String}
         * @default https://wabli-laughing-invention.cyclopt.services:3010/v1
         */
        this.basePath = 'https://wabli-laughing-invention.cyclopt.services:3010/v1'.replace(/\/+$/, '');
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "https://wabli-laughing-invention.cyclopt.services:3010/v1",
